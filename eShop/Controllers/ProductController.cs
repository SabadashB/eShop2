...
namespace eShop.Controllers
{
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        [Authorize(Roles = "admin")]
        public async Task<ActionResult> Add(ProductViewModel model, Category category)
        {
        ...
        [HttpPost]
        [Authorize(Roles = "admin")]
        public async Task<IActionResult> Edit(ProductViewModel model, Category category)
        {
